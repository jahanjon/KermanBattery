...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KBA.Domain.Entity.Battery.BatteryDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KBA.Domain.Entity.Event.EventType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KBA.Domain.Entity.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KBA.Domain.Entity.Products.Product", b =>
                {
                    b.HasOne("KBA.Domain.Entity.Battery.BatteryDetails", null)
                        .WithMany("Products")
                        .HasForeignKey("BatteryDetailsId");

                    b.HasOne("KBA.Domain.Entity.Battery.BatteryDetails", "BatteryDetails")
                        .WithMany()
                        .HasForeignKey("ProductBatteryDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KBA.Domain.Entity.Event.EventType", "EventType")
                        .WithMany("Products")
